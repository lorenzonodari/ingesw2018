...
public interface InputGetter {
	...
	/**
	 * Acquisisce un numero in virgola mobile nell'intervallo [min, max] (estremi inclusi), lanciando
	 * un'eccezione se il dato acquisito non e' un numero o se tale numero non rientra nel range
	 * richiesto
	 * 
	 * Precondizione: min <= max
	 ...
	 */
	float getFloat(float min, float max) throws NumberFormatException;
